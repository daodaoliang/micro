...
public class StandardThreadExecutor extends ThreadPoolExecutor {
	...
	public StandardThreadExecutor(int coreThreads, int maxThreads,
			int queueCapacity) {
		this(coreThreads, maxThreads, queueCapacity, Executors
				.defaultThreadFactory());
	}

	public StandardThreadExecutor(int coreThreads, int maxThreads,
			int queueCapacity, ThreadFactory threadFactory) {
		this(coreThreads, maxThreads, DEFAULT_MAX_IDLE_TIME,
				TimeUnit.MILLISECONDS, queueCapacity, threadFactory);
	}
	...
	public StandardThreadExecutor(int coreThreads, int maxThreads,
		...
		super(coreThreads, maxThreads, keepAliveTime, unit,
				new ExecutorQueue(), threadFactory, handler);
...
class ExecutorQueue extends LinkedTransferQueue<Runnable> {
	...
	public void setStandardThreadExecutor(
			StandardThreadExecutor threadPoolExecutor) {
